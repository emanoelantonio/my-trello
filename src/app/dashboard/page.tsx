...
import { Filter, Grid3X3, List, Plus, Rocket, Search, SquareActivity, Trello } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-4 sm:space-y-0">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">My Boards</h2>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0">
              <div className="flex items-center rounded space-x-2 bg-white border p-1">
                <Button
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFilters((prev) => ({
                      ...prev, dateRange: { ...prev.dateRange, start: e.target.value || null, }
                    }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="date"
                    onChange={(e) => setFilters((prev) => ({
                      ...prev, dateRange: { ...prev.dateRange, end: e.target.value || null, }
                    }))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFilters((prev) => ({
                      ...prev, taskCount: {
                        ...prev.taskCount, min: e.target.value
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setFilters((prev) => ({
                      ...prev, taskCount: {
                        ...prev.taskCount, max: e.target.value
                          ? Number(e.target.value) : null,
                      }
                    }))}
                  />
      ...
      <Dialog open={showUpgradeDialog} onOpenChange={setShowUpgradeDialog}>
        <DialogContent className="w-[95vw] max-w-106.25 mx-auto">
          <DialogHeader>
            <DialogTitle>Upagrade to create More Boards</DialogTitle>
            <p className="text-sm text-gray-600">
